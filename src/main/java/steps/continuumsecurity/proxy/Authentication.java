...
public interface Authentication {
     ...
     * @param contextId Id of a {@link steps.continuumsecurity.proxy.model.Context}
    ...
    /**
     * Enables a {@link User} for a given {@link steps.continuumsecurity.proxy.model.Context} id and user id.
     * @param contextId Id of a {@link steps.continuumsecurity.proxy.model.Context}
     * @param userId Id of a {@link User}
    ...
    /**
     * Sets a {@link User} id as forced user for the given {@link steps.continuumsecurity.proxy.model.Context}
     * @param contextId Id of a context.
     * @param userId Id of a user.
     * @throws ProxyException
     */
