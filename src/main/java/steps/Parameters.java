...
class Parameters {
    ...
    //GLOBAL VARS TO USE
    final static String[] SELENIUM_BROWSER_ARGUMENTS = {"--browser.download.manager.showWhenStarting=false",
    ...
    final static String OWASP_ZAP_HTTP_IP = "127.0.0.1";
    final static int OWASP_ZAP_HTTP_PORT = 9090;
}